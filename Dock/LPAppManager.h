...
@class LPRoot, LPStorage, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_xpc_object>, NSSet;
...
- (void)_findExistingRunnableMatching:(id)arg1 atPath:(id)arg2 resolveURLs:(BOOL)arg3 withExisting:(id)arg4;
- (void)_matchRunnable:(id)arg1 withPath:(id)arg2 toRunnables:(id)arg3 checked:(id)arg4 withURLS:(id)arg5 returnBlock:(id)arg6;
