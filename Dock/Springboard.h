...
- (double)_getZoomFactorFromPrefs;
...
- (void)performOpenAnimationForRunnable:(id)arg1 withImage:(struct CGImage *)arg2 atFrame:(struct CGRect)arg3 toFrame:(struct CGRect)arg4;
